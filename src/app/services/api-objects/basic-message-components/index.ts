...
import { LocationJson } from './src/location-json';
...
export { BasicResponseJson, KnoraAccess, KnoraIRI, KnoraListNodeIRI, KnoraRights, KnoraStatusCode, KnoraValue, LocationJson, ProjectItemJson, UserdataJson }
